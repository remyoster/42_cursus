...
unsigned int FragTrap::getBaseHitPoints() const { 
	return 100;
}
unsigned int FragTrap::getBaseMaxHitPoints() const {
	return 100;
}
unsigned int FragTrap::getBaseEnergyPoints() const {
	return 100;
}
unsigned int FragTrap::getBaseMaxEnergyPoints() const {
	return 100;
}
unsigned int FragTrap::getBaseMeleeAttackDamage() const {
	return 30;
}
unsigned int FragTrap::getBaseRangedAttackDamage() const {
	return 20;
}
unsigned int FragTrap::getBaseArmorReduction() const { 
	return 5;
}