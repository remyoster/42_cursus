...
/*   Updated: 2020/09/01 09:33:55 by roster           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	usage(void)
{
	ft_putstr("usage: ./philo_two|two|three nb_philo time_to_die time_to_eat");
...
** condition to true (in order to stop monitor)
*/
